...
function drawGorilla() {
  // render tge gorilla at it's position, choosing the correct image for animation playback
...
class Spiral {
  ...
  constructor(x, y) { // runs once, each time and object is made
    this.x = x; this.y = y;
    this.currentFrame = 0;
